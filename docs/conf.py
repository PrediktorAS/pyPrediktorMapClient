...
module_dir = os.path.join(__location__, "../src/pyprediktormapclient")
try:
...
try:
    from pyprediktormapclient import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "pyPrediktorMapClient-doc"
